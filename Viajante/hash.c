...
#define CANT_PRIMOS 18

// Proposicion: Redimensionar para arriba con FC>0.75 y para abajo con FC<0.4
const int numeros_primos[] = {7, 17, 23, 37, 61, 101, 163, 269, 439, 719, 1171, 1951, 3253, 5419, 9029, 15053, 25087, 41813};
...
void hash_iterar(hash_t *hash, bool (*visitar)(void *dato, void *extra), void *extra){
